  ...
  <main class="register-page">
    ...
    <section class="register-wrap">
      <section class="register-panel">
        <div class="register-badge owner"><i class="fa-solid fa-house"></i><i class="fa-regular fa-futbol ball"></i></div>
        <h1>Registro Propietario</h1>
        <div class="register-divider"></div>

        <form class="reg-form" action="../php/registrar-propietario.php" method="POST">
          <div class="reg-input"><i class="fa-solid fa-user"></i><input type="text" name="nombre" placeholder="Nombre y Apellido" required></div>
          <div class="reg-input"><i class="fa-solid fa-building"></i><input type="text" name="nombreCancha" placeholder="Nombre de la Cancha" required></div>
