...
<head>
  ...
  <title>Registro Usuario | AlquilaTuCancha</title>
  ...
  <main class="register-page">
    <section class="register-wrap">
      <section class="register-panel">
        ...
        <p class="register-sub">Crea tu cuenta gratis para buscar y reservar canchas</p>
        ...
        <form class="reg-form" action="../php/registrar-usuario.php" method="POST" novalidate>
          <div class="reg-input">
